...
const ForgotPassword = () => {
  ...
  return (
    ...
    //             <input type='number' required name='password' placeholder='Enter password' value={data.password} onChange={handleChange} className='w-full h-full outline-none bg-transparent'/>
