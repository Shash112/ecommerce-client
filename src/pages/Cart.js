...
const Cart = () => {
  ...
  return (
    <div className='container mx-auto'>
        ...
        <div className='flex flex-col items-center md:items-start md:flex-row gap-10 md:justify-between p-4'>   
                {/***view product */}
                <div className='w-full max-w-3xl overflow-y-scroll md:h-[calc(100vh-170px)]'>
                    {
                        loading ? (
